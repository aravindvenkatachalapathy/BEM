% -----------------------------
% Script:  
% Solution to Exercise to Lecture #6 of Course "Wind Energy Basics"
% ----------------------------------
...
legend('Betz','NREL')
ResizeAndSaveFigure(16,12,['ComparisonTwistAngle.pdf'])
...
legend('Betz','NREL')
ResizeAndSaveFigure(16,12,['ComparisonChordLength.pdf'])
